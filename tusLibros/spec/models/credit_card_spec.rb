...
describe CreditCard do
  ...
  let(:invalid_credit_card) { CreditCard.create(credit_card_owner: an_invalid_credit_card_owner, credit_card_number: a_credit_card_number, expiration_date: an_expiration_date) }
  let(:valid_credit_card_number_1) { CreditCard.create!(credit_card_owner: a_valid_credit_card_owner, credit_card_number: a_valid_credit_card_number, expiration_date: a_valid_expiration_date) }
  let(:valid_credit_card_number_2) { CreditCard.create!(credit_card_owner: 'Marco Gatti', credit_card_number: '1234567890123456', expiration_date: a_valid_expiration_date) }
  context 'When creating a credit card' do
    ...
    context 'and the expiration date has already past' do
      let(:an_expiration_date) { "1/2/1990" }
