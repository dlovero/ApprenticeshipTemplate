...
describe Cashier do
  context 'When checking out with a valid credit card' do
    ...
    let(:a_credit_card) { CreditCard.create!(credit_card_owner: a_valid_credit_card_owner, credit_card_number: a_valid_credit_card_number, expiration_date: a_valid_expiration_date) }
